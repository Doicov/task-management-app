    ...
    <Box display="flex" gap={3} mb={3}>
      <TextField 
        ...
        sx={{
            ...
            "& .MuiInput-underline:before": { borderBottomColor: "rgba(255, 255, 255, 0.4)" }, // Цвет линии до фокуса
            "& .MuiInput-underline:hover:before": { borderBottomColor: "white !important" }, // Цвет линии при наведении
